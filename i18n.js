...
window.I18N = {
  de: {
    ...
    btnLock: "Sperren",
    controlsHint: "<b>Entsperren</b> schreibt die oben eingestellten Geschwindigkeiten auf die drei Gänge, <b>Sperren</b> setzt alle drei wieder auf den eingestellten Sperr-Wert (Standard 22). Der Knopf zeigt jeweils die nächste sinnvolle Aktion.",
    lockLabel: "Sperr-Wert (km/h)",
    lockHint: "Manche Roller peaken beim Anfahren kurz 1 bis 2 km/h über den Wert. Stell 19 bis 22 so ein dass der Peak im gesperrten Zustand unter 22 bleibt. Wird im Browser gemerkt.",
    ...
    gearHint: "Diese drei Werte sind die entsperrten Geschwindigkeiten für die deutschen Gänge (intern ESC-Gang 2, 3 und 4). <b>Entsperren</b> schreibt sie, <b>Sperren</b> setzt alle drei auf den eingestellten Sperr-Wert (Standard 22). Gang 1 und Gang 5 gibt es nur im Ausland und werden nicht angefasst.",
  ...
  en: {
    ...
    btnUnlock: "Unlock",
    btnLock: "Lock",
    controlsHint: "<b>Unlock</b> writes the speeds set above to the three gears, <b>Lock</b> sets all three back to the chosen lock value (default 22). The button shows the next sensible action.",
    lockLabel: "Lock value (km/h)",
    lockHint: "Some scooters briefly peak 1 to 2 km/h above the set value on start-up. Pick 19 to 22 so the peak stays under 22 when locked. Remembered in your browser.",
    ...
    gearHint: "These three values are the unlocked speeds for the German gears (internally ESC gears 2, 3 and 4). <b>Unlock</b> writes them, <b>Lock</b> sets all three to the chosen lock value (default 22). Gears 1 and 5 exist only abroad and are left untouched.",
