...
window.I18N = {
  de: {
    pageTitle: "Laufbursche Blade Mini (eKFV) Tool",
    brandSub: "Blade Mini (eKFV) Tool",
    langGroup: "Sprache",
    ...
    btnLock: "Sperren",
    controlsHint: "<b>Entsperren</b> schreibt die oben eingestellten Geschwindigkeiten auf die drei Gänge, <b>Sperren</b> setzt sie auf die pro Gang eingestellten Sperr-Werte (Standard 10/15/21). Der Knopf zeigt jeweils die nächste sinnvolle Aktion.",
    ...
    fw348Title: "Firmware 3.4.8 - Test möglich",
    fw348Msg: "Dein Scooter meldet Version {ver}. Du kannst hier testen, aber es funktioniert potenziell nicht mit deiner Firmware: auf 3.4.8 sitzt die Drossel tief in der ESC-Firmware. Bitte per Live-Cam prüfen ob sich die Geschwindigkeit ändert und mir das Ergebnis melden.",
    gearHint: "Die Speed-Werte sind die entsperrten Geschwindigkeiten für die deutschen Gänge (intern ESC-Gang 2, 3 und 4), die Sperr-Werte die gesperrten. <b>Entsperren</b> schreibt die Speed-Werte, <b>Sperren</b> die Sperr-Werte (Standard 10/15/21). Gang 1 und Gang 5 gibt es nur im Ausland und werden nicht angefasst.",
  ...
  en: {
    ...
    btnUnlock: "Unlock",
    btnLock: "Lock",
    controlsHint: "<b>Unlock</b> writes the speeds set above to the three gears, <b>Lock</b> sets them to the per-gear lock values (default 10/15/21). The button shows the next sensible action.",
    ...
    fw348Title: "Firmware 3.4.8 - testing possible",
    fw348Msg: "Your scooter reports version {ver}. You can test here, but it may not work with your firmware: on 3.4.8 the limiter sits deep in the ESC firmware. Please check via live cam whether the speed changes and report the result back to me.",
    gearHint: "The Speed values are the unlocked speeds for the German gears (internally ESC gears 2, 3 and 4), the Lock values are the locked ones. <b>Unlock</b> writes the Speed values, <b>Lock</b> the lock values (default 10/15/21). Gears 1 and 5 exist only abroad and are left untouched.",
